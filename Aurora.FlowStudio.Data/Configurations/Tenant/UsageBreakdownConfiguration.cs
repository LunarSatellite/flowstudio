...
{
    public class UsageBreakdownConfiguration : IEntityTypeConfiguration<UsageBreakdown>
    {
        public void Configure(EntityTypeBuilder<UsageBreakdown> builder)
        {
            // Table name
            builder.ToTable("UsageBreakdowns");
            ...
            //     .HasDatabaseName("IX_UsageBreakdowns_SomeProperty");
