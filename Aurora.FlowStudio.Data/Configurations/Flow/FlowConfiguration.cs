...
{
    public class FlowConfiguration : IEntityTypeConfiguration<Entity.Flow.Flow>
    {
        public void Configure(EntityTypeBuilder<Entity.Flow.Flow> builder)
        {
            // Table name
            ...
            //     .HasDatabaseName("IX_Flows_SomeProperty");
